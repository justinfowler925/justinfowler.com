...
<a class="skip" href="#guide">Skip to guide</a><div class="container"><nav aria-label="Main navigation"><a class="mark" href="/">Justin Fowler</a><div class="nav-links"><a href="/open-source.html">Public work</a><a href="https://github.com/justinfowler925/scout">Private repository</a></div></nav>
...
'''+''.join(body)+'''</main><footer><p><a href="https://github.com/justinfowler925/scout">Private repository · access required</a> · <a href="https://nucleus-clearspeed.vercel.app/company-tools">Nucleus Company Tools</a></p><p>© 2026 Justin Fowler · <a href="/privacy.html">Privacy</a></p></footer></div>
